...
parser.add_argument('--dataset_root', default='./mtwi_train',
...
parser.add_argument('--num_workers', default=4, type=int,
                    help='Number of workers used in dataloading 线程数')
    ...
    for iteration in range(start_iter, cfg['max_iter']):
        ...
        if iteration % 1000 == 0:
            ...
            if not os.path.isdir('checkpoint'):
                os.mkdir('checkpoint')
            torch.save(checkpoint, 'checkpoint/ssd_{}.pth'.format(args.dataset))
